...
push-image-to-sandbox: ## Builds custom TFX image and pushes to sandbox for manual testing
	@docker build -t eu.gcr.io/ml-sandbox-101/custom_gpu_tfx_image_nbcu_1:local -f training/Dockerfile . & \
	docker push eu.gcr.io/ml-sandbox-101/custom_gpu_tfx_image_nbcu_1:local
