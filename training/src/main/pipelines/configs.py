...
BQ_TABLE = 'synopsis_genres_170_clustered_tags' #'synopsis_dylan_150tag_with_tokens_and_keywords'#merlin_data_with_lang_type_keywords, 'synopsis_dylan_150tag_with_tokens_and_keywords'
